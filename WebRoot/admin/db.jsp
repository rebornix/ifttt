...
<%@ page import="Bean.*" %>
<jsp:useBean id="accountlistbean" scope="session" class="Bean.AccountListBean" type ="Bean.AccountListBean"/>
    ...
    <div id="sidebar-wrapper">
      ...
      <ul id="main-nav">
        ...
        <li> <a href="#" class="nav-top-item current">
          ...
          Articles </a>
          <ul>
            <li><a class="current" href="#">Manage User Info</a></li>
            <!-- Add class "current" to sub menu items also -->   
	  </ul>
        </li>
        <li> <a href="#" class="nav-top-item"> Messages </a>
          <ul>
	    <li><a href="/ifttt/admin/msgdb.jsp">Manage Public Messages</a></li>
      ...
      <div id="messages" style="display: none">
        ...
        <form action="/ifttt/servlet/SendMessage" method="post">
          ...
          <select name="dropdown" class="small-input">
            ...
            <option value="option4">GreatShang</option>
          </select>
        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <tbody>
              ...
              <% 
              	int amount = accountlistbean.getAccountAmount();
              	String[] usernames = new String[amount];
              	int[] moneys = new int[amount];
              	int[] level = new int[amount];
              	int[] logs = new int[amount];
              	logs = accountlistbean.getRecordAmount();
              	level = accountlistbean.getLevel();
              	moneys = accountlistbean.getMoney();
              	usernames = accountlistbean.getUserNames();
              	for(int i = 0; i < amount; i++){
               		out.print("<tr><td><input type=\"checkbox\" /></td><td>");
               		out.print(usernames[i]);
                	out.print("</td><td><a href=\"#\" title=\"title\">");
                	out.print(moneys[i]);
            	    out.print("</a></td><td>");
                	out.print(level[i]);
                	out.print("</td><td>");
                	...
                	out.print("</td><td>");
                	%>
                	<a href="" title="Edit"><img src="/ifttt/admin/resources/images/icons/pencil.png" alt="Edit" /></a> <a href="" title="Delete"><img src="/ifttt/admin/resources/images/icons/cross.png" alt="Delete" /></a> <a href="#" title="Edit Meta"><img src="/ifttt/admin/resources/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a>
                </td>
               <%
               		out.print("</tr>");
               		}
