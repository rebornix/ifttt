    ...
    <div id="sidebar-wrapper">
      ...
      <ul id="main-nav">
	    ...
	    <li><a href="/ifttt/admin/msgdb.jsp" >Manage Public Messages</a></li>
            <li><a href="#" class="current">Manage User Messages</a></li>
          </ul>
        </li>
      ...
      <div id="messages" style="display: none">
        ...
        <form action="/ifttt/adminservlet/SendMessage" method="post">
          <h4>New Message</h4>
          <fieldset>
